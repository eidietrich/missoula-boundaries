...
export default class CountyIncomeResults extends React.Component {
  constructor(props){
    super(props)
  }
  ...
  render() {
    ...
    const lineChart = <TrendChart
      ...
      trendFunction={(d, i, data) => {
        return {x: d.year, y: d.perCapitaIncome};
      }}
    />

    return (
      <div className="metric-container">
        <div className="metric-header">Per-capita Income</div>
        <div className="metric-description">{description}</div>
        {lineChart}
        <div className="metric-note">Data: U.S. Bureau of Economic Analysis</div>
      </div>
    );
  }
